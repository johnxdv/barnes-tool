...
export function EstimationCharacteristicsStep({ detection, onBack, onValidate }) {
  ...
  return (
    /* Le formulaire seul, centré, sur deux colonnes de cartes.

       Une troisième colonne tenait à sa droite un grand immeuble à l'encre qui
       montait d'une tranche à chaque champ réglé. L'intention se défend — une
       récompense au geste — mais l'effet ne tenait pas : l'écran est le seul du
       parcours à demander un vrai travail de saisie, une quinzaine de cartes à
       régler, et un dessin qui bougeait à chaque réglage disputait l'attention
       au champ qu'on était en train de remplir. Il a été retiré, et le
       formulaire a retrouvé toute la largeur. */
      ...
      <form onSubmit={handleSubmit} className="mt-10">
        ...
        <div className="grid items-start gap-5 lg:grid-cols-2 lg:gap-6">
          <Colonne colonne={COLONNES.bien} delai={0.05}>
            ...
            {/* Le cadre de vie — vue, exposition, luminosité — ne se saisit
                plus ici. Ces trois cartes ont été retirées, et c'est un relevé
                qui les remplace : `src/lib/cadre.js` déduit l'orientation des
                façades de l'emprise du bâtiment, le dégagement des emprises
                voisines, le surplomb du relief. Les trois lignes arrivent
                renseignées au rapport, chacune avec la phrase qui dit d'où
                elle sort — et modifiables, comme tout le reste, pour l'agent
                qui a vu ce que la géométrie ne montre pas. */}
            <SegmentedField
              key="standing"
              label="Standing"
